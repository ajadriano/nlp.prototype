...
<xsl:template match="S[count(S)=0][NP[(NNP|NNPS) and *[@nsubj]] and VP[VBZ[@cop and @lemma='be'] and JJ]]">
...
<xsl:template match="S[count(S)=0][(NNP|NNPS)[@nsubj] and VP[VBZ[@cop and @lemma='be'] and JJ]]">
DataPropertyAssertion(
        <xsl:call-template name="adj_to_data_property">
            <xsl:with-param name="adj" select="VP/JJ" />
        </xsl:call-template>
